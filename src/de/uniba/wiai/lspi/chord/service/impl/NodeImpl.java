...
//		}
	...
	@Override
	public Node findSuccessor(ID key, HopCount hopCount) throws CommunicationException {
		// TODO Auto-generated method stub
		return this.impl.findSuccessor(key, hopCount);

	}
	
	@Override
	public void awakeFromCrash(){
		this.myEndpoint.awakeFromCrash();
	}
	@Override
	public void simulateCrash(){
		this.myEndpoint.simulateCrash();
	}
